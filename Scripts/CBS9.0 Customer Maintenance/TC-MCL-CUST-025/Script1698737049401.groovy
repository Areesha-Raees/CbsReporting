...
selenium.click("xpath=//div[@id='cdk-overlay-2']/div/div/button[4]")
...
selenium.type("id=mat-input-2", "deere")
selenium.click("xpath=//div[@id='cdk-overlay-4']/div/div/div/button")
