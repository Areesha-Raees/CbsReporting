...
selenium.type("id=mat-input-10", "324424")
...
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-4']/cbs-grid-popup-editor-dialog/mat-dialog-content/reactive-dynamic-form/form/div/form-lov/div/mat-form-field/div/div/div[2]/button/span")
...
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-7']/cbs-lov-dialog/mat-dialog-content/form/div/div/mat-form-field/div/div/div")
...
selenium.type("id=mat-input-125", "34244")
selenium.click("id=mat-input-126")
selenium.type("id=mat-input-126", "it")
...
selenium.click("xpath=//a[@id='ui-tabpanel-16-label']/span")
selenium.click("xpath=//div[@id='ui-tabpanel-16']/cbs-grid-popup-editor/div/div[2]/table/tbody/tr/td[2]/div")
selenium.doubleClick("xpath=//mat-dialog-container[@id='mat-dialog-9']/cbs-grid-popup-editor-dialog/mat-dialog-content/reactive-dynamic-form/form/div/form-input-number/div/mat-form-field/div/div/div")
selenium.click("id=mat-input-145")
selenium.type("id=mat-input-145", "3442")
selenium.click("xpath=//mat-select[@id='mat-select-74']/div/div/span")
selenium.click("xpath=//div[3]/div[4]")
selenium.click("id=mat-input-146")
selenium.type("id=mat-input-146", "3242434")
selenium.click("xpath=//mat-select[@id='mat-select-75']/div/div/span")
selenium.click("xpath=//div[3]/div[4]")
selenium.click("id=mat-input-147")
selenium.type("id=mat-input-147", "34234")
selenium.click("id=mat-input-149")
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-9']/cbs-grid-popup-editor-dialog/mat-dialog-content/reactive-dynamic-form/form/div")
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-9']/cbs-grid-popup-editor-dialog/mat-dialog-actions/div/button/span/mat-icon")
