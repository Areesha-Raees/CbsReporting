...
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav/div/perfect-scrollbar/div/div/tree-root/tree-viewport/div/div/tree-node-collection/div/tree-node[3]/div/tree-node-children/div/tree-node-collection/div/tree-node/div/tree-node-wrapper/div/tree-node-expander")
...
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-customer-query/cbs-query-screen/div/mat-card/mat-card-content/div/td-paging-bar/div/div[2]/button[2]/span/mat-icon")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-customer-query/cbs-query-screen/div/mat-card/mat-card-content/div/td-paging-bar/div/div[2]/button[2]/span/mat-icon")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-customer-query/cbs-query-screen/div/mat-card/mat-card-content/div/div/table/tbody/tr[7]/td[2]/div")
selenium.open("http://202.69.40.229:7003/cbs9/#/customer-workspace/00000000000000000421/mcl-cw/stand-alone-screen/customer-dashboard;clientName=RAGNAR%20LOTHBROK")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-header-perspective-bar/mat-toolbar/button/span")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav/div/perfect-scrollbar/div/div/tree-root/tree-viewport/div/div/tree-node-collection/div/tree-node[3]/div/tree-node-wrapper/div/div")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav/div/perfect-scrollbar/div/div/tree-root/tree-viewport/div/div/tree-node-collection/div/tree-node[3]/div/tree-node-children/div/tree-node-collection/div/tree-node/div/tree-node-wrapper/div/div")
selenium.open("http://202.69.40.229:7003/cbs9/#/customer-workspace/00000000000000000421/mcl-cw/detail-screen/client-limit-facility-setup;clientName=RAGNAR%20LOTHBROK")
...
selenium.type("id=mat-input-2", "3254452")
...
selenium.click("xpath=//mat-checkbox[@id='mat-checkbox-248']/label")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-customer-workspace/div/cbs-client-limit-facility-setup/cbs-detail-screen/mat-card/mat-card-content/md2-tabs/div[2]/md2-tab/cbs-grid-popup-editor/div/div/span[4]/button/span/mat-icon")
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-2']/cbs-grid-popup-editor-dialog/mat-dialog-content/md2-tabs/div[2]/md2-tab/reactive-dynamic-form/form/div/form-lov/div/mat-form-field/div/div/div[2]/button/span/mat-icon")
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-3']/cbs-lov-dialog/mat-dialog-content/cbs-query-list/mat-card/mat-card-content/div/table/tbody/tr[5]/td[2]")
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-2']/cbs-grid-popup-editor-dialog/mat-dialog-content/md2-tabs/div[2]/md2-tab/reactive-dynamic-form/form/div/form-lov[2]/div/mat-form-field/div/div/div[2]/button/span")
...
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-2']/cbs-grid-popup-editor-dialog/mat-dialog-content/md2-tabs/div[2]/md2-tab/reactive-dynamic-form/form/div/form-input-date[2]/div/mat-form-field/div/div/div[2]/span/button/span")
selenium.click("xpath=//owl-date-time-container[@id='owl-dt-picker-4']/div[2]/owl-date-time-calendar/div/div/button/span")
selenium.click("xpath=//owl-date-time-container[@id='owl-dt-picker-4']/div[2]/owl-date-time-calendar/div[2]/owl-date-time-multi-year-view/table/tbody/tr[3]/td[2]/span")
selenium.click("xpath=//owl-date-time-container[@id='owl-dt-picker-4']/div[2]/owl-date-time-calendar/div[2]/owl-date-time-year-view/table/tbody/tr[4]/td/span")
selenium.click("xpath=//owl-date-time-container[@id='owl-dt-picker-4']/div[2]/owl-date-time-calendar/div[2]/owl-date-time-month-view/table/tbody/tr/td[2]/span")
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-2']/cbs-grid-popup-editor-dialog/mat-dialog-content/md2-tabs/div[2]/md2-tab/reactive-dynamic-form/form/div/form-input-pct/div/mat-form-field/div/div/div")
selenium.click("id=mat-input-17")
selenium.type("id=mat-input-17", "0")
