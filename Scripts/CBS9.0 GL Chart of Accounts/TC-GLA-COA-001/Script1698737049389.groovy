...
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-query/cbs-query-screen/div/mat-card/mat-card-content/div/mat-toolbar/span[6]/button")
...
selenium.click("xpath=//mat-option[@id='mat-option-34']/span")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-content/dynamic-form/form/div/form-select[2]/div/mat-form-field/div/div/div")
selenium.click("xpath=//mat-option[@id='mat-option-36']/span")
...
selenium.click("xpath=//owl-date-time-container[@id='owl-dt-picker-0']/div[2]/owl-date-time-calendar/div[2]/owl-date-time-month-view/table/tbody/tr/td[2]/span")
...
selenium.click("xpath=//div[@id='cdk-overlay-11']/div/div/button[4]")
selenium.click("xpath=//div[@id='cdk-overlay-13']/div/div/div/mat-list/mat-list-item/div/mat-form-field/div/div/div")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-query/cbs-query-screen/div/mat-card/mat-card-content/div/div/table/th[2]/span/span/cbs-grid-options/button/span/mat-icon")
selenium.click("xpath=//div[@id='cdk-overlay-11']/div/div/button[4]")
selenium.click("xpath=//div[@id='cdk-overlay-13']/div/div/div/mat-list/mat-list-item/div/mat-form-field/div/div/div")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-query/cbs-query-screen/div/mat-card/mat-card-content/div/div/table/th[2]/span/span/cbs-grid-options/button/span/mat-icon")
...
selenium.click("xpath=//mat-option[@id='mat-option-106']/span")
selenium.click("id=mat-input-16")
selenium.type("id=mat-input-16", ("Trade of Marks").toString())
selenium.click("xpath=//div[@id='cdk-overlay-13']/div/div/div/button")
