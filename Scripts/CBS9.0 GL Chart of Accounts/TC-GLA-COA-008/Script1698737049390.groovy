...
selenium.click("xpath=//mat-option[@id='mat-option-42']/span")
selenium.click("id=mat-input-3")
selenium.type("id=mat-input-3", "ledger")
selenium.click("id=mat-input-2")
selenium.type("id=mat-input-2", "21312")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-header/mat-card-actions/button[4]")
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-1']/cbs-message-dialog/button")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-content/dynamic-form/form/div/form-lov/div/mat-form-field/div/div/div[2]/button/span/mat-icon")
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-2']/cbs-lov-dialog/mat-dialog-content/cbs-query-list/mat-card/mat-card-content/div/table/tbody/tr/td[2]")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-header/mat-card-actions/button[4]/span/mat-icon")
selenium.open("http://202.69.40.229:7003/cbs9/#/workspace/gla/detail-screen/chart-account-detail/21312")
...
selenium.click("xpath=//div[@id='cdk-overlay-10']/div/div/button[4]")
selenium.click("xpath=//mat-select[@id='mat-select-16']/div/div/span")
selenium.click("xpath=//mat-option[@id='mat-option-69']/span")
selenium.click("id=mat-input-12")
selenium.type("id=mat-input-12", "21312")
selenium.click("xpath=//div[@id='cdk-overlay-12']/div/div/div/button")
