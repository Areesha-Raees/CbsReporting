...
selenium.click("id=mat-input-45")
selenium.type("id=mat-input-45", "pro")
selenium.type("id=mat-input-45", ("Prof Account").toString())
selenium.click("id=mat-input-44")
selenium.type("id=mat-input-44", "125689")
...
selenium.click("xpath=//mat-select[@id='mat-select-54']/div/div/span")
selenium.click("xpath=//div[3]/div")
selenium.click("xpath=//mat-select[@id='mat-select-53']/div/div/span")
selenium.click("xpath=//mat-option[@id='mat-option-273']/span")
selenium.click("xpath=//mat-select[@id='mat-select-54']/div/div[2]")
selenium.click("xpath=//mat-option[@id='mat-option-276']/span")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-content/dynamic-form/form/div/form-select[3]/div/mat-form-field/div/div/div")
selenium.click("xpath=//mat-option[@id='mat-option-269']/span")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-content/dynamic-form/form/div/form-input-date/div/mat-form-field/div/div/div[2]/span/button/span/mat-icon")
selenium.click("xpath=(.//*[normalize-space(text()) and normalize-space(.)='May 2022'])[1]//*[name()='svg'][1]")
selenium.click("xpath=//owl-date-time-container[@id='owl-dt-picker-12']/div[2]/owl-date-time-calendar/div[2]/owl-date-time-multi-year-view/table/tbody/tr[3]/td[2]/span")
selenium.click("xpath=//owl-date-time-container[@id='owl-dt-picker-12']/div[2]/owl-date-time-calendar/div[2]/owl-date-time-year-view/table/tbody/tr[4]/td/span")
selenium.click("xpath=//owl-date-time-container[@id='owl-dt-picker-12']/div[2]/owl-date-time-calendar/div[2]/owl-date-time-month-view/table/tbody/tr/td[2]/span")
selenium.click("id=mat-input-44")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-header/mat-card-actions/button[4]/span/mat-icon")
...
selenium.click("xpath=//mat-select[@id='mat-select-61']/div/div[2]/div")
selenium.click("xpath=//mat-option[@id='mat-option-299']/span")
selenium.click("id=mat-input-54")
selenium.type("id=mat-input-54", "125689")
selenium.click("xpath=//div[@id='cdk-overlay-64']/div/div/div/button")
