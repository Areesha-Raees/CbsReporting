...
selenium.click("xpath=//a[@id='Chart of Accounts']/span/mat-icon")
...
selenium.click("xpath=//div[@id='cdk-overlay-20']/div/div/button[2]")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-query/cbs-query-screen/div/mat-card/mat-card-content/div/div/table/tbody/tr/td[2]/div")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-header/mat-card-actions/button[2]/span/mat-icon")
selenium.click("xpath=//mat-select[@id='mat-select-28']/div/div[2]")
selenium.click("xpath=//mat-option[@id='mat-option-147']/span")
selenium.click("id=mat-input-19")
selenium.type("id=mat-input-19", ("Account of Ledger").toString())
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-header/mat-card-actions/button[4]/span/mat-icon")
...
selenium.click("xpath=//div[@id='cdk-overlay-26']/div/div/button[4]")
selenium.click("xpath=//mat-select[@id='mat-select-32']/div/div/span")
selenium.click("xpath=//mat-option[@id='mat-option-159']/span")
selenium.click("id=mat-input-23")
selenium.type("id=mat-input-23", "21312")
selenium.click("xpath=//div[@id='cdk-overlay-28']/div/div/div/button")
