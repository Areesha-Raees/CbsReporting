...
selenium.click("xpath=//mat-select[@id='mat-select-25']/div/div/span")
selenium.click("xpath=//mat-option[@id='mat-option-135']/span")
...
selenium.click("xpath=//mat-dialog-container[@id='mat-dialog-1']/cbs-lov-dialog/mat-dialog-content/cbs-query-list/mat-card/mat-card-content/div/table/tbody/tr[7]/td[2]/div")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-content/dynamic-form/form/div/form-select[3]/div/mat-form-field/div")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-content/dynamic-form/form/div/form-select[2]")
selenium.click("xpath=//mat-select[@id='mat-select-26']/div/div[2]/div")
selenium.click("xpath=//mat-option[@id='mat-option-136']/span")
...
selenium.type("id=mat-input-18", "353454363")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-content/dynamic-form/form/div/form-input[2]/div/mat-form-field/div/div/div")
selenium.type("id=mat-input-19", ("TD - IT related").toString())
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-detail/cbs-detail-screen/mat-card/mat-card-header/mat-card-actions/button[4]/span/mat-icon")
selenium.click("xpath=//a[@id='Chart of Accounts']/span")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-query/cbs-query-screen/div/mat-card/mat-card-content/div/div/table/th[2]/span/span/cbs-grid-options/button/span/mat-icon")
selenium.click("xpath=//div[@id='cdk-overlay-28']/div/div/button[4]")
selenium.click("xpath=//div[@id='cdk-overlay-30']/div/div/div/mat-list/mat-list-item/div/mat-form-field/div/div/div")
selenium.click("xpath=//app-root[@id='container']/div/div[3]/mat-sidenav-container/mat-sidenav-content/layout-main-container/layout-side-navigation-container/mat-sidenav-container/mat-sidenav-content/layout-content-canvas/cbs-workspace/div/cbs-chart-account-query/cbs-query-screen/div/mat-card/mat-card-content/div/div/table/th[2]/span/span/cbs-grid-options/button/span/mat-icon")
selenium.click("xpath=//div[@id='cdk-overlay-28']/div/div/button[4]")
selenium.click("xpath=//mat-select[@id='mat-select-37']/div/div/span")
selenium.click("xpath=//mat-option[@id='mat-option-189']/span")
selenium.click("id=mat-input-30")
selenium.type("id=mat-input-30", ("TD - IT related").toString())
selenium.click("xpath=//div[@id='cdk-overlay-30']/div/div/div/button")
